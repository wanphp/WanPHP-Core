...
class ThirdPartyPlatforms
{
  ...
  {
    $this->APPID = getenv('WECHAT_THIRD_PARTY_PLATFORMS_APPID') ?: '';
    $this->AppSecret = getenv('WECHAT_THIRD_PARTY_PLATFORMS_APP_SECRET') ?: '';
    $this->message_token = getenv('WECHAT_THIRD_PLATFORMS_MESSAGE_TOKEN') ?: '';
    $this->message_encodingAesKey = getenv('WECHAT_THIRD_PARTY_PLATFORMS_MESSAGE_ENCODING_AES_KEY') ?: '';
