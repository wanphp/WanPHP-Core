...
use WanPHP\Core\Repositories\WeiXin\Traits\HttpTrait;
use WanPHP\Core\Repositories\WeiXin\Traits\ImageOcrTrait;
use WanPHP\Core\Repositories\WeiXin\Traits\MiniProgramDataCubeTrait;
use WanPHP\Core\Repositories\WeiXin\Traits\MiniProgramSubscribeMessageTrait;
...
class MiniProgram
{
  ...
  {
    $this->appid = getenv('WECHAT_MINI_PROGRAM_APPID') ?? '';
    $this->appSecret = getenv('WECHAT_MINI_PROGRAM_SECRET') ?? '';
